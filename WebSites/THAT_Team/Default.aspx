...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="http://go.microsoft.com/fwlink/?LinkId=301949">Aprende Aquí</a>
            </p>
        ...
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="http://go.microsoft.com/fwlink/?LinkId=301949">Más información</a>
            </p>
        </div>
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="http://go.microsoft.com/fwlink/?LinkId=301950">Ver Sitios</a>
            </p>
        </div>
    </div>
</asp:Content>
